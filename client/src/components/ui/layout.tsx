...
import { Coins, LineChart, BarChart3, Signal, Bot, BookOpen, Users, FileText, 
  Settings, Activity, MessageSquare, Podcast } from 'lucide-react';
...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white flex">
      {/* Sidebar */}
      <div className="hidden md:flex md:w-64 min-h-screen flex-col bg-gray-900 border-r border-gray-800">
