...
class NotificationService2 {
  private static instance: NotificationService2;
  ...
  public static getInstance(): NotificationService2 {
    if (!NotificationService2.instance) {
      NotificationService2.instance = new NotificationService2();
    }
    return NotificationService2.instance;
  }
...
export const notificationService2 = NotificationService2.getInstance();