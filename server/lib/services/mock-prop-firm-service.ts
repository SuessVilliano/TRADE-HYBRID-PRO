  ...
  private mockChallenges = [
    {
      ...
      description: 'Trade futures with standard risk parameters',
      marketType: 'futures',
    ...
    },
    {
      ...
      description: 'Trade forex with advanced parameters for experienced traders',
      marketType: 'forex',
      brokerModel: 'oanda',
    ...
    },
    {
      ...
      description: 'Trade crypto with enhanced risk parameters',
      marketType: 'crypto',
      brokerModel: 'alpaca',
      accountSizes: [5000, 10000, 25000],
      phases: 1,
      targetProfitPhase1: 12,
