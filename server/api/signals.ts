...
const globalSignals: SignalStorage = {
  crypto: [
    ...
    },
    {
      ...
      Time: '09:15:00',
      Provider: 'Solaris',
      Notes: 'Bearish trend forming on 5min chart',
    },
    {
      id: 'hybrid-4-1743604123461',
      Symbol: 'AVAXUSDT',
      Asset: 'AVAXUSDT',
      Direction: 'BUY',
      'Entry Price': 42.15,
  ...
  futures: [
    ...
    },
    {
      ...
      Time: '11:05:00',
      Provider: 'Solaris',
      Notes: 'S&P500 bounce from support level',
    },
    {
      id: 'hybrid-6-1743604123463',
      Symbol: 'GC1!',
      Asset: 'GC1!',
      Direction: 'BUY',
      'Entry Price': 2318.40,
      ...
      Time: '09:45:00',
      Provider: 'Hybrid',
      Notes: 'Gold buy opportunity after pullback',
    }
  ],
  forex: [
    {
    ...
    },
    {
      ...
      Time: '12:45:00',
      Provider: 'Paradox',
      Notes: 'GBPJPY short opportunity - Risk 0.5% only',
    },
    {
      id: 'hybrid-8-1743604123465',
      Symbol: 'USDCAD',
      Asset: 'USDCAD',
      Direction: 'BUY',
      'Entry Price': 1.33821,
      ...
      Time: '15:20:00',
      Provider: 'Hybrid',
      Notes: 'USDCAD in 10min chart forming bullish pattern',
    }
  ]
};
