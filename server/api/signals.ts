...
// Global signals available to everyone - real webhook data only, no demo signals
const globalSignals: SignalStorage = {
  crypto: [
    // Only real webhook signals will be added here via processWebhookSignal function
  ],
  futures: [
    // Only real webhook signals will be added here via processWebhookSignal function
  ],
